...
import com.marcsedev.horoscoapp.ui.detail.HoroscopeDetailActivity
...
class MainActivityTest {
    ...
    fun when_mainactivity_is_created_then_open_luck_fragment() {
        Espresso.onView(withId(R.id.luckFragment)).perform(ViewActions.click())
    }

    @Test
    fun when_horoscope_is_selected_then_open_detail() {

        Espresso.onView(withId(R.id.rvHoroscope)).perform(
